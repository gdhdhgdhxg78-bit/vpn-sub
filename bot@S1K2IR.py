...
# ==================== تنظیمات ====================
BOT_TOKEN        = "8757886517:AAE9mJ1_UY-88sYhUzZMtwaULj7dONnLKwo"
...
ALL_PERMS = ["toggle_bot", "stats", "users", "add_config", "delete_configs", "broadcast", "coins", "channels", "support_id", "buttons", "colors", "ad_channels", "premium_emojis", "start_reaction", "ban_reaction", "smart_channels", "leave_alert"]
PERM_NAMES = {
...
TEXT_NAMES = {
    ...
    "referral_response": "متن پاسخ لینک دعوت ({link} {ref_count} {coins} {needed} {per_ref})",
